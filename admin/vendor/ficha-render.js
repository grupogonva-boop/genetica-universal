...
(function(global){
  ...
  function renderFichaHTML(t,linearTraits){
    ...
    <div class="bull-sheet-scroll catalog-sheet-scroll">
      ...
      <header class="catalog-titlebar"><div><small>FICHA 360° · HOLSTEIN · 08/2026</small><h2 id="fichaTitle">${t.nombreRegistrado||t.nombre}</h2></div><div class="catalog-title-id"><span>${t.codigo}</span><small>${availability(t.disponibilidad).label}</small></div></header>
